window.onload = () => {
    ...
    let orberby = ['idUsuario', false, (a, b) => 0]
    ...
    id.onclick = () => {
        orberby[2] = orberby[0] == "idUsuario" ? !orberby[2]: orberby[2];
        orberby[0] = "idUsuario";
        orberby[3] = numSort;
    ...
    nome.onclick = () => {
        orberby[2] = orberby[0] == "nome" ? !orberby[2]: orberby[2];
        orberby[0] = "nome";
        orberby[3] = strSort;
        update.dispatchEvent(clickEvent);
    };
    ...
    nascimento.onclick = () => {
        orberby[2] = orberby[0] == "dataNascimento" ? !orberby[2]: orberby[2];
        orberby[0] = "dataNascimento"
        orberby[3] = strSort;
        update.dispatchEvent(clickEvent);
    };
    telefone.onclick = () => {
        orberby[2] = orberby[0] == "telefone" ? !orberby[2]: orberby[2];
        orberby[0] = "telefone"
        orberby[3] = strSort;
        update.dispatchEvent(clickEvent);
    };
    cpf.onclick = () => {
        orberby[2] = orberby[0] == "cpf" ? !orberby[2]: orberby[2];
        orberby[0] = "cpf"
        orberby[3] = strSort;
        update.dispatchEvent(clickEvent);
    };
    email.onclick = () => {
        orberby[2] = orberby[0] == "email" ? !orberby[2]: orberby[2];
        orberby[0] = "email"
        orberby[3] = strSort;
        update.dispatchEvent(clickEvent);
    };
    cep.onclick = () => {
        orberby[2] = orberby[0] == "cep" ? !orberby[2]: orberby[2];
        orberby[0] = "cep"
        orberby[3] = strSort;
        update.dispatchEvent(clickEvent);
    };
    rua.onclick = () => {
        orberby[2] = orberby[0] == "rua" ? !orberby[2]: orberby[2];
        orberby[0] = "rua"
        orberby[3] = strSort;
        update.dispatchEvent(clickEvent);
    };
    municipio.onclick = () => {
        orberby[2] = orberby[0] == "municipio" ? !orberby[2]: orberby[2];
        orberby[0] = "municipio"
        orberby[3] = strSort;
        update.dispatchEvent(clickEvent);
    };
    estado.onclick = () => {
        orberby[2] = orberby[0] == "estado" ? !orberby[2]: orberby[2];
        orberby[0] = "estado"
        orberby[3] = strSort;
        update.dispatchEvent(clickEvent);
    };
    complemento.onclick = () => {
        orberby[2] = orberby[0] == "complemento" ? !orberby[2]: orberby[2];
